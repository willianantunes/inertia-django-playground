...
todos_patterns = (
    [
        ...
        path("<int:target_id>/edit/", views.todos_edit, name="edit"),
        path("<int:target_id>/delete/", views.todos_delete, name="delete"),
    ],
    "todos",
)
...
credit_cards_patterns = (
    [
        ...
        path("<int:target_id>/update/", views.credit_cards_update, name="update"),
        path("<int:target_id>/delete/", views.credit_cards_delete, name="delete"),
    ],
    "credit_cards",
)
